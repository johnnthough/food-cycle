  ...
  useEffect(() => {
    ...
    const runInference = async () => {
      if (videoRef.current && videoRef.current.readyState === 4) {
        ...
        const trackedPredictions = predictions
          ...
          .map((pred) => {
            ...
            if (timeVisible > 2000) {
              setHistory((prev) => {
                if (
                  prev[0]?.class === className &&
                  now - prev[0].addedAt < 5000
                )
                  return prev;
          ...
          <header className="bg-slate-900 p-5 rounded-2xl border border-slate-800 flex justify-between items-center shadow-lg">
            <div>
              ...
              <p className="font-outfit text-slate-500 text-xs mt-1">
                Live AI Inventory System v5.0 (Mobile Optimized)
              </p>
            </div>
            {/* ... rest of header */}
          </header>
              ...
              <div className="flex flex-col items-center justify-center h-full space-y-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-500 text-sm mt-1">
                    Launch the AI scanner to identify items.
                  </p>
                </div>
                <button
                  disabled={!isReady}
